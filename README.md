# Apodemus peninsulae 生境适宜性预测

*大林姬鼠（*Apodemus peninsulae*）在气候变化背景下的生境分布预测*

## 项目概述

本仓库包含山东大学本科毕业论文《气候变化背景下大林姬鼠在中国的生境适宜性预测》的全部分析代码与数据。

**核心目标**：利用物种分布模型（SDM）预测大林姬鼠在当前及未来（SSP126、SSP245、SSP585三个排放情景，2050年代）的生境适宜性变化，为鼠传疾病风险预警提供基础数据。

## 论文信息

- **题目**：气候变化背景下大林姬鼠在中国的生境适宜性预测
- **作者**：刘一静
- **学校**：山东大学（威海）
- **年份**：2026
...
```bibtex
@thesis{liu2026apodemus,
  author  = {刘一静},
  title   = {气候变化背景下大林姬鼠在中国的生境适宜性预测},
  school  = {山东大学（威海）},
  year    = {2026}
}
```
